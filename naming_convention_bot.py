...
def generate_code_ui(file_type_choice):
    ...
    discipline_options = {
        ...
        "Outside plant network": "OPN", "Power": "PWR", "Public Address System": "PAS",
    ...
    file_type_options = {
        ...
        "Audit Report": "AUR", "Plan": "PLN", "Bill of Quantities": "BOQ", "Policy": "PCY", "Critical Design Report": "CDR", "Presentation": "PRE", "Calculation" : "CAL" , "Procedure" : "PRO", "Certificate" : "CER" , "Profile" : "PRF" , "Claim": "CLM" , "Proposal" : "PSL","Communication Plan":"CPL", "Register":"REG", "Execution plan" : "EPL",
